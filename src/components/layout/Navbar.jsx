    ...
    <header className="sticky top-0 z-50 w-full border-b border-border bg-cream/95 backdrop-blur-md">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <Link to="/" className="group flex items-center gap-2">
          <div className="flex h-9 w-9 items-center justify-center rounded-xl bg-wander-600 text-white shadow-sm transition group-hover:bg-wander-700">
        ...
        <div className="hidden md:block">
          <Link
            to="/plan-trip"
            className="rounded-xl bg-wander-600 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition-all hover:bg-wander-700 hover:shadow-md"
          >
            Start Planning
          </Link>
        </div>
        ...
        <div className="border-t border-border bg-cream px-4 pb-5 pt-3 md:hidden">
          ...
          <div className="mt-4 border-t border-border pt-4">
            <Link
              to="/plan-trip"
              onClick={() => setIsOpen(false)}
              className="block w-full rounded-xl bg-wander-600 px-5 py-3 text-center text-sm font-medium text-white shadow-sm transition hover:bg-wander-700"
            >
              Start Planning
            </Link>
          </div>
